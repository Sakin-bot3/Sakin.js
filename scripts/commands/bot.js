...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "তাসকিয়া শুনা আমার তোমার অলিতে গলিতে উম্মাহ😇😘",
          "তাসকিয়া কি গো সোনা আমাকে ডাকছ কেনো",
          "তাসকিয়া বার বার আমাকে ডাকস কেন😡",
          "আহ তাসকিয়া শোনা আমার আমাকে এতো ডাক্তাছো কেনো আসো বুকে আশো🥱",
          "হুম তাসকিয়া জান তোমার অইখানে উম্মমাহ😷😘",
          "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি",
          "তাসকিয়া তোমাকে চুদি",
          "I will fuck you Taskiya",
          "Taskiya and I with dogy sty**le🤭"
        ];
